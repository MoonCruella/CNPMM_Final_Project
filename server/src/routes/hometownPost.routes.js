...
import { authenticateToken, checkAuth, requireAdmin } from '../middleware/auth.middleware.js';
...
router.get('/:identifier', checkAuth, getPostDetail); // Dùng checkAuth để biết user là ai, nhưng không bắt buộc đăng nhập
