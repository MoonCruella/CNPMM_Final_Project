...
// Protected routes
router.get('/profile/:userId', authenticateToken, requireOwnerOrAdmin, getUserProfile);
router.put('/profile/:userId', authenticateToken, requireOwnerOrAdmin, updateUserProfile);
