...
const authService = {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        try {
          ...
          console.error('getCurrentUser failed after profile update:', getUserError);
  ...
  verifyOtpForgotPassword: async (email, otp) => {
    return await api.post("/api/auth/forgot-password/verify-otp", { email, otp });
  },

  resetPassword: async (email, newPassword) => {
    return await api.post("/api/auth/forgot-password/reset", { email, newPassword });
  }
};
