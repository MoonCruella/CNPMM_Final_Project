...
const Dashboard = () => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "orders":
        return <MyOrdersPage></MyOrdersPage>
      case "notifications":
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      ...
      {/*   FIX: Main Content Layout - Sidebar và Content cùng hàng */}
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row gap-6 items-start"> {/*   Thêm items-start */}
          {/* Sidebar - Left Column */}
            ...
            <div className="hidden md:block bg-white rounded-lg shadow-md p-4 mb-4">
              <div className="flex flex-col items-center text-center">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition cursor-pointer"
                >
                  Chỉnh sửa hồ sơ
                </button>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <nav className="py-2">
                ...
                <button
                  ...
                  className={`w-full flex items-center px-4 py-3 text-left cursor-pointer transition ${
                    activeSection === "notifications"
                      ? "bg-green-50 text-green-700 font-medium border-l-4 border-green-700 hover:bg-gray-200"
                  ...
                  {accountMenuOpen && (
                    <div className="bg-gray-50">
                      <button
                        ...
                        className={`w-full flex items-center px-4 py-2.5 pl-12 text-left text-sm cursor-pointer transition ${
                          activeSection === "account" && !location.pathname.includes('/profile')
                            ? "text-green-700 font-medium bg-green-100 hover:bg-gray-200 "
