...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white backdrop-blur-sm transition-all shadow-sm">
        <NavLink to="/" className="flex items-center gap-2 whitespace-nowrap">
          <img className="h-9" src={assets.logo} alt="logo" />
          <span className="ml-2 text-lg font-semibold">Pyspecials</span>
        </NavLink>
        ...
        <div className="hidden sm:flex items-center font-bold gap-8">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `relative border-b-2 transition duration-300 ${
                isActive
      ...
      {/* spacer để tránh nội dung bị che bởi navbar cố định */}
